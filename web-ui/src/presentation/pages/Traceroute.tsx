...
const Title = styled.h1`
  ...
  color: ${theme.colors.text};
  span { color: ${theme.colors.textMuted}; font-weight: 400; margin-left: 0.4rem; }
`;
...
const StatsBar = styled.div`
  position: absolute;
  top: calc(clamp(5.5rem, 8vh, 7rem) + 64px);
  left: 50%;
  transform: translateX(-50%);
  z-index: 999;
  display: flex;
    ...
    <Page>
      ...
      <TopBar>
        <TitleBlock>
          ...
          <Title>Traceroute<span>live network path</span></Title>
        </TitleBlock>
        <InputCell>
          <Input
            type="text"
